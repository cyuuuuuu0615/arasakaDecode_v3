...
//
//@TeleOp(name = "AA teleop_v3_SCY_ANTI_SHAKE_FINAL")
//public class teleop_v3SCY extends LinearOpMode {
//
//    // === 1. 硬體組件 ===
...
//
//    // 遠程加速：保持動力
//    private static final double K_P_FAST = 0.0028;
//    // 近程制動：大幅降低 P 以免在 800 附近過衝，提高 D 以硬停
//    private static final double K_P_STABLE = 0.0003;
//    private static final double K_D_STABLE = 0.0015 ;
//    private static final double K_I_STABLE = 0.00000;
//
//    private static final double DISK_TOLERANCE = 110; // 寬死區是加速比結構的救星
//    private static final double DISK_MAX_POWER = 1.0;
//
//    // === 3. 位置設定 ===
//    private static final double POS_FILL_A = 0;
//    private static final double POS_FILL_B = 2623;
//    private static final double POS_FILL_C = 5315;
//    private static final double POS_FIRE_A = -2014;
//    private static final double POS_FIRE_B = 592;
//    private static final double POS_FIRE_C = 3253;
//
//    // === 4. 狀態機變數 ===
...
//
//            updateTelemetry();
//            telemetry.addData("CurrentPos", intakeMotor.getCurrentPosition());
//        }
//    }
//
...
//
//        // 最小功率門檻（防止低頻震盪）
//        if (Math.abs(power) < 0.12) power = 0;
//
//        lastDiskPower = Math.max(-DISK_MAX_POWER, Math.min(DISK_MAX_POWER, power));
//        diskServo.setPower(lastDiskPower);
//        diskLastError = error;
//
//        telemetry.addData("TargetPos", diskTargetPosition);
//        telemetry.addData("CurrentPos", intakeMotor.getCurrentPosition());
//        telemetry.addData("RawPower", pOutput + iOutput + dOutput); // 看看計算出的原始推力
//    }
