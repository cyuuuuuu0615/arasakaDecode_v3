...
@TeleOp(name = "A BULE test Teleop")
public class teleop_v5 extends LinearOpMode {
    ...
    // === 參數設定 ===
    // 裝球位置 (Filling)
    private static double FILL_POS_STEP_1 = 0.0;     // Hole A
    private static double FILL_POS_STEP_2 = 0.28;  // Hole B SCY MOD
    private static double FILL_POS_STEP_3 = 0.5355;  // Hole C SCY MOD
...
//    private static final double offset = 0;
    ...
    private static final double GATE_L_OPEN = 0.69;
...
//        FIRE_POS_HOLE_A = (FIRE_POS_HOLE_A + offset);
//        FIRE_POS_HOLE_B = (FIRE_POS_HOLE_B + offset);
//        FIRE_POS_HOLE_C = (FIRE_POS_HOLE_C + offset);
//        FILL_POS_STEP_1 = (FILL_POS_STEP_1 + offset);
//        FILL_POS_STEP_2 = (FILL_POS_STEP_2 + offset);
//        FILL_POS_STEP_3 = (FILL_POS_STEP_3 + offset);
            ...
            try {
                ...
                if (result != null && result.isValid()) {
                    ...
                    for (com.qualcomm.hardware.limelightvision.LLResultTypes.FiducialResult tag : result.getFiducialResults()) {
                        if (tag.getFiducialId() == 20) { // 改為鎖定 24 號
                            targetValid = true;
