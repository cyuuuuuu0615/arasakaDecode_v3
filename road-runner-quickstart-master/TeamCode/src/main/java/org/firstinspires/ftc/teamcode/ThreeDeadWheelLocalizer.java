...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2574.477867427356; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2629.4605919303935; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -0.7635508514277185; // x position of the perpendicular encoder (in tick units)
    }
