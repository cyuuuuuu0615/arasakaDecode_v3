...
@Config
@Autonomous
public class auto_timer extends LinearOpMode{   //60cm:25unit          1 cm: 5/12 unit
    double lefthandin = 0;
    double lefthandout = 1;
    double lefehandxiaoout = 0.21;
    double righthandxiaoout = 1 - lefehandxiaoout;
...
//                        .stopAndAdd(new zhengshouGetSpec())
//                        .stopAndAdd(new ParallelAction(
//                                drive.actionBuilder(secondPose).setReversed(true)
//                                .splineTo(new Vector2d(40 - 25,50 - 55),-Math.PI*1.75).build(),
//                                new shenshoufangdongxi()
//
//                        ))
//                        .setReversed(false)
...
//                        ))
//                        .setReversed(false)
//                        .splineTo(new Vector2d(35.5 - 25 + 12 - 8*5/12,-16.5),Math.PI*1.633)
//                        .stopAndAdd(new zhengshouGetSpec())
//                        .setReversed(true)
//                        .splineTo(new Vector2d(40.5 - 25,50.5 - 55),-Math.PI*1.75)
//                        .stopAndAdd(new ParallelAction(
...
//                .splineTo(new Vector2d(10,-40),Math.PI/15)
                        .stopAndAdd(new auto_timer.xiaozhengshouGetSpec())
...
//__________________________________________________________________________
            ...
            while (action){
                long xianzaishijian = System.currentTimeMillis() - startTimeget;
                if(xianzaishijian < 1000) {
    ...
    public class xiaozhengshouGetSpec implements Action{
        boolean get = false;
        public ColorSensor colorSensor;
        Servo jiazixiaobi = hardwareMap.get(Servo.class,"servo2");
        Servo shoubi = hardwareMap.get(Servo.class,"servo6");
...
//                    }
                    if(colorSensor.red() <= 600){
                        lefthand.setPosition(lefehandxiaoout);
                        righthand.setPosition(righthandxiaoout);
//                    if (!inRange(colorSensor.red(), 600, 1300)) {
                        zhuazi1.setPower(1);
                        zhuazi0.setPower(-1);
                        startTime = System.currentTimeMillis();
