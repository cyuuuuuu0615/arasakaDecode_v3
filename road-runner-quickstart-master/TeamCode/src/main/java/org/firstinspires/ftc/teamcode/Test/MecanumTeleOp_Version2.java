...
@TeleOp
public class MecanumTeleOp_Version2 extends LinearOpMode {
...
//                }
                ...
                if (isSequenceStarted5){
                    ...
                    if(currentTime5 > 2000 - 1500 - 500){
                        updown = true;
                    }
                    if ((currentTime5 > 3500 - 1500 -500) && (currentTime5 < 4500 - 1500 - 500)){
                        chanzi.setPosition(chanziup);
                    }
                    else if(currentTime5 < 5500 - 1500 - 500){
                        chanzi.setPosition(chanziping);
                    }
                    else{
