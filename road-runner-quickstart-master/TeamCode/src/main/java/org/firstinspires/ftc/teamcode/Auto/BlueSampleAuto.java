...
@Config
@Autonomous
public class BlueSampleAuto extends LinearOpMode{   //60cm:25unit          1 cm: 5/12 unit
    double lefthandin = 0;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d secondPose = new Pose2d(35.5 - 25,-16,Math.PI*1.5);
...
//                .stopAndAdd(new REDAutoSP.naspecimen())
//                .splineToLinearHeading(new Pose2d(-40/2.5,25    ,Math.PI*1.5),Math.PI/2)
//                .stopAndAdd(new REDAutoSP.shenbispecimen())
//                .strafeTo(new Vector2d(-40/2.5,28))
//                .stopAndAdd(new REDAutoSP.shenshoufangspecimen())
//
//
//                .splineTo(new Vector2d(20,50),Math.PI/2)
//                .strafeTo(new Vector2d(24 + 10,50))
//                .strafeTo(new Vector2d(24 + 10, 10))
//                .strafeTo(new Vector2d(44 - (66/2.5),2))
//
//                // ##################################################################################################
//                .stopAndAdd(new REDAutoSP.naspecimen())
//                .splineToLinearHeading(new Pose2d(-40/2.5,25    ,Math.PI*1.5),Math.PI/2)
...
//                .strafeTo(new Vector2d(-40/2.5,28))
//                .stopAndAdd(new REDAutoSP.shenshoufangspecimen())
//                .splineToLinearHeading(beginPose, Math.PI*1.5)
//                .stopAndAdd(new REDAutoSP.naspecimen())
//                .splineToLinearHeading(new Pose2d(-40/2.5,25    ,Math.PI*1.5),Math.PI/2)
//                .stopAndAdd(new REDAutoSP.shenbispecimen())
//                .strafeTo(new Vector2d(-40/2.5,28))
...
//        );
        Actions.runBlocking(new SequentialAction(drive.actionBuilder(beginPose)
                ...
                .stopAndAdd(new BlueSampleAuto.zhengshouGetSpec())
                .setReversed(true)
                .splineTo(new Vector2d(40 - 25,50 - 55),-Math.PI*1.75)
                .stopAndAdd(new ParallelAction(
                        new BlueSampleAuto.shenshoufangdongxi()
                ))
                .setReversed(false)
